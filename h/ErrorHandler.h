...
{
public:
	PhplusError(string msgIn, ErrorPriority priorityIn, Token tokenIn=nullptr);
...
//typedef shared_ptr<PhplusError> Err;

//Err makeError(string msgIn, ErrorPriority priorityIn, Token tokenIn=nullptr) {return Err(new PhplusError(msgIn, priorityIn, tokenIn));}
